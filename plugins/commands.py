...
async def start_message(c, m):
    ...
    # Welcome message
    text = (
        f"<b><blockquote> Hey Dear! 👋 {m.from_user.mention}</blockquote></b>\n\n"
        ...
        "<b><blockquote>ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @Chosen_Onex</blockquote></b>"
    )

    # Buttons layout
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆", url="http://t.me/Auto_Join_Request_Approver_X_Bot?startgroup=true&admin=invite_users")],
        [
            InlineKeyboardButton("• 𝐉𝐨𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 •", url="https://t.me/II_Way_to_Success_II"),
            InlineKeyboardButton("• 𝐉𝐨𝐢𝐧 𝐆𝐫𝐨𝐮𝐩 •", url="https://t.me/GeniusJunctionX")
        ],
        [InlineKeyboardButton("⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ⇆", url="http://t.me/Auto_Join_Request_Approver_X_Bot?startchannel=true&admin=invite_users")],
